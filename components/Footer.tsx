      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/services" className="text-gray-300 hover:text-orange transition-colors">Brake Repair</Link></li>
              <li><Link href="/services" className="text-gray-300 hover:text-orange transition-colors">Oil Change</Link></li>
              <li><Link href="/services" className="text-gray-300 hover:text-orange transition-colors">Engine Diagnostics</Link></li>
              <li><Link href="/services" className="text-gray-300 hover:text-orange transition-colors">Wheel Alignment</Link></li>
              <li><Link href="/services" className="text-gray-300 hover:text-orange transition-colors">Air Conditioning</Link></li>
            </ul>
          </div>
